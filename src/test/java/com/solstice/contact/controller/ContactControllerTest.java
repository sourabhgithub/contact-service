...
public class ContactControllerTest {
  ...
  public void
    ...
    given(this.contactService.updateContact(anyLong(), any())).willReturn(Optional.empty());
    mockMvc
        .perform(
            put("/contacts/{id}", 1L)
                .contentType(MediaType.APPLICATION_JSON_UTF8)
  ...
  @Test
  public void
      deleteContact_givenValidContactId_whenMethodInvoked_shouldDeleteContactAndReturnNoContent()
          throws Exception {
  ...
  public void deleteContact_givenInvalidContactId_whenMethodInvoked_shouldReturnNotFoundException()
    ...
    doThrow(new ResourceNotFoundException())
        .when(this.contactService)
        .deleteContact(any(Long.class));
